...
const WhatIsArcs = () => {
  return (
    <div className="relative w-full min-h-screen bg-[#01061B] flex overflow-hidden text-white font-inter flex-col md:flex-row items-center justify-center">
      ...
      <div className="flex-2 flex-col relative p-2 md:p-0 order-2 md:order-1 lg:flex lg:flex-col lg:justify-bottom lg:items-end lg:pl-10 md:ml-10 lg:ml-20">  {/* Added margin to shift right */}
        <div className='flex flex-col'>
          <h1 className="text-4xl md:text-6xl lg:text-4xl font-bold mb-6 md:mb-8 text-nowrap">  {/* Adjusted text sizes */}
            WHAT IS ARCS?
          </h1>
          
          <div className="mb-8 max-w-[100%] md:max-w-[80%] lg:max-w-[80%] leading-relaxed text-lg md:text-lg lg:text-lg line-clamp-8">  {/* Adjusted text sizes and max widths */}
            <p>
          ...
          <div className="mb-6 max-w-full md:max-w-[80%] lg:max-w-[85%] leading-relaxed text-lg md:text-lg lg:text-lg line-clamp-8">  {/* Adjusted text sizes and max widths */}
            <p>
      ...
      <div className="hidden md:flex md:w-screen md:h-screen p-5 md:p-0 order-3 object lg:w-full">
        <img 
          src="two.svg" 
