...
function Happie(){
    return(
        <div className="relative bg-[#01061B] h-screen overflow-hidden flex md:p-0 min-[500px]:p-6 p-5">
            ...
            <div className="md:relative lg:left-[8vw] md:left-[6vw] md:top-[7vh] bg-[#474C78]/70 h-fit 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:-rotate-6 p-4 absolute w-11/12 top-[20vh] small:top-[21vh]">
            ...
            <div className="md:relative 2xl:left-[27vw] lg:left-[22vw] md:left-[12vw] md:top-[7vh] bg-[#474C78]/70 h-fit 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:rotate-6 p-4 absolute w-11/12 small:top-[42vh] top-[40vh]">
            ...
            <div className="absolute lg:left-[63vw] md:left-[60vw] md:top-[68vh] bg-[#474C78]/70 md:h-52 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:-rotate-6 p-4 w-11/12 h-fit small:top-[81vh] top-[80vh]">
