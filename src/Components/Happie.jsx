    ...
    return(
        <div className="relative bg-[#01061B] h-screen overflow-hidden flex md:p-0 min-[500px]:p-6 p-5">
            ...
            <div className="absolute lg:left-[63vw] md:left-[60vw] md:top-[68vh] bg-[#474C78]/70 md:h-52 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:-rotate-6 p-4 w-11/12 h-fit portrait:small:top-[81vh] top-[79vh]">
                ...
                <p className="xl:mt-3 md:mt-1 text-[#CDCFD7] font-source-serif xl:text-base md:text-sm font-semibold portrait:small:text-xs"><img src="dp.svg" className="inline-block mr-3 w-10 h-10 portrait:small:w-7 portrait:small:h-7 pointer-events-none select-none"/>Aesh From Team Basanti</p>
            </div>
