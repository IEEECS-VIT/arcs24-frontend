  ...
  return (
    <div className="relative animated-gradient h-screen overflow-hidden flex md:p-0 min-[500px]:p-6 p-5">
      ...
      <div className="md:relative lg:left-[8vw] md:left-[6vw] md:top-[7vh] bg-[#474C78]/70 h-fit 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:-rotate-6 p-4 absolute w-11/12 top-[26vh] portrait:small:top-[25vh]">
        ...
        <p className="xl:mt-3 md:mt-1 text-[#CDCFD7] font-source-serif xl:text-base md:text-sm font-semibold portrait:small:text-xs">
          <img src="p12.jpeg" className="inline-block mr-3 w-10 h-10 portrait:small:w-7 rounded-3xl portrait:small:h-7 pointer-events-none select-none" />
      ...
      <div className="md:relative 2xl:left-[27vw] lg:left-[22vw] md:left-[12vw] md:top-[7vh] bg-[#474C78]/70 h-fit 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:rotate-6 p-4 absolute w-11/12 portrait:small:top-[45vh] top-[44vh]">
        ...
        <p className="xl:mt-3 md:mt-1 text-[#CDCFD7] font-source-serif xl:text-base md:text-sm font-semibold portrait:small:text-xs">
          <img src="p13.jpeg" className="inline-block mr-3 w-10 h-10 portrait:small:w-7 rounded-3xl portrait:small:h-7 pointer-events-none select-none" />
      ...
      <div className="absolute lg:left-[8vw] md:left-[6vw] md:top-[70vh] bg-[#474C78]/70 h-fit 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl p-4 md:rotate-6 w-11/12 top-[60vh] portrait:small:top-[61.5vh]">
        ...
        <p className="xl:mt-3 md:mt-1 text-[#CDCFD7] font-source-serif xl:text-base md:text-sm font-semibold portrait:small:text-xs">
          <img src="p11.jpeg" className="inline-block mr-3 w-10 h-10 rounded-3xl portrait:small:w-7 portrait:small:h-7 pointer-events-none select-none" />
      ...
      <div className="absolute lg:left-[63vw] md:left-[60vw] md:top-[68vh] bg-[#474C78]/70 md:h-52 2xl:w-1/4 xl:w-96 lg:w-80 md:w-72 rounded-3xl xl:p-7 md:-rotate-6 p-4 w-11/12 h-fit portrait:small:top-[81vh] top-[79vh]">
        ...
        <p className="xl:mt-3 md:mt-1 text-[#CDCFD7] font-source-serif xl:text-base md:text-sm font-semibold portrait:small:text-xs">
          <img src="dp.svg" className="inline-block mr-3 w-10 h-10 portrait:small:w-7 portrait:small:h-7 pointer-events-none select-none" />
