...
export default function Part1() {
  return (
    <div
      className="div1 relative m-0 h-full md:ml-[2.2552083333333335vw] md:mt-0 md:flex"
      id="events"
    >
      <img
      ...
      />
      <img
        className="img25 relative z-10 ml-[2.5vw] h-0 md:mt-[12vh] md:h-[30vw] md:w-[25vw] lg:mt-[0] lg:h-[25vw]"
        src="Group223.png"
      ></img>
      <img
        className="imh26 z=15 relative mr-[5vw] mt-[8vh] h-0 sm:mt-[0vh] md:mt-[15vh] md:h-[30vh] lg:mt-[6vh] lg:h-[35vh]"
        src="Group141.png"
      ></img>
      <img
        ...
        alt=""
      />
      <div className="d2 mt-[2.5vh] flex sm:ml-[10vw] md:ml-[5vw] md:mt-[2vw]">
        <img
        ...
        <div className="d6 mt-[8vw] w-[81.744791666666668vw] text-center sm:w-[50vw] sm:text-[0.8rem] md:mt-[5.849557522123893vh] md:w-[51.744791666666668vw] md:text-start md:text-[1.5rem] lg:text-[1.875rem]">
          ...
          <p className="p2 text-md m-0 mt-[0.5vw] font-source-serif font-semibold leading-[151%] tracking-[0.2604166666666667vw] md:ml-[0] md:text-3xl">
            tech innovators gather for
          </p>
          <p className="p2 text-md m-0 mt-[0.5vw] font-source-serif font-semibold leading-[151%] tracking-[0.2604166666666667vw] md:ml-[0] md:text-3xl">
            groundbreaking challenges, keynote
          </p>
          <p className="p2 text-md m-0 mt-[0.5vw] font-source-serif font-semibold leading-[151%] tracking-[0.2604166666666667vw] md:text-3xl">
            sessions, and engaging activities that ignite creativity and drive
            innovation .
          </p>
        </div>
        <img
          className="img3 mt-[40vw] h-[6.7926675094816686vh] w-[7.2135416666666665vw] sm:mt-[22.5vh] md:mr-[5.25625vw] md:mt-[37.92667509481669vh] md:h-[8.099873577749683vh] md:w-[3.958984375vw]"
          src="/Group112.svg"
          alt=""
        />
      </div>
